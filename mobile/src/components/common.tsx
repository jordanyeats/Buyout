...
export function CountUp({ value, style, format = money }: { value: number; style?: TextStyle | TextStyle[]; format?: (n: number) => string }) {
  ...
  return <Text style={style}>{format(disp)}</Text>;
}
